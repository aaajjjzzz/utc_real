function [V_1,V_2,iter,obj_rec,difY1_rec,difY2_rec] = ASL234_um_move(L1,L2,L3,cls_num,opts,lambda1,lambda2)
...
V_1 = zeros(n_1,cls_num);
V_2 = zeros(n_2,cls_num);
Y1 = zeros(n_2,cls_num);
Y2 = zeros(cls_num,cls_num);
